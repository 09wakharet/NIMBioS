  ...
  dem_scale_factor = .5 #multiples all demographic processes
  ...
  control <- control.dcm(nsteps = 10, dt = 0.01, new.mod = SIRTwo)
  ...
  plot(mod, y = c("s.num","s2.num"), main = "Phase shift sensitivity analysis", legend = "full")
